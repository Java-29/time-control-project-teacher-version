...
describe('AccountingServiceMongoImpl.getAllEmployees', () => {
    ...
    test('Test passed: There are some employees', () => __awaiter(void 0, void 0, void 0, function* () {
        EmployeeModel.find.mockResolvedValue(empArr);
        const result = yield service.getAllEmployees();
        expect(EmployeeModel.find).toHaveBeenCalledWith({});
        expect(result).toEqual(empArr);
    }));
    test("Test passed: There aren't any employees", () => __awaiter(void 0, void 0, void 0, function* () {
